      ...
      <div  className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 items-center justify-center mx-auto gap-8">
        <div data-aos="zoom-in-up">
          <img
            ...
            alt=""
          />
          <h3 className="text-red-800 font-bold text-xl">Mrs Helena Crown</h3>
        ...
        <div data-aos="zoom-in-up">
          <img
            ...
            alt=""
          />
          <h3 className="text-red-800 font-bold text-xl">Charlotte</h3>
        ...
        <div data-aos="zoom-in-up">
          <img
            ...
            alt=""
          />
          <h3 className="text-red-800 font-bold text-xl">David malnar</h3>
        ...
        <div data-aos="zoom-in-up">
          <img
            ...
            alt=""
          />
          <h3 className="text-red-800 font-bold text-xl">Olivia</h3>
