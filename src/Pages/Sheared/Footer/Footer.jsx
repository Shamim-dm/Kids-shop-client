    ...
    <div>
      <footer className="footer  p-10 bg-base-200 text-base-content">
        <div>
          <img
            className="h-28"
            src="https://i.ibb.co/cb0TqPr/Ride-On-Electric-Car.png"
            alt=""
          />
        ...
        <div>
          ...
          <a className="link link-hover">Outdoor Toys</a>
          <a className="link link-hover">Cars & Vehicles</a>
        </div>
        <div>
      ...
      <div className="divider font-bold py-5">Copyright 2023 Developer. All Rights Reserved.</div> 
    </div>
  );
};
